...
img_path = "./data/predata/pre0002.jpg"
...
def random_crop_image(image_file, num):
    with tf.Graph().as_default():
        ...
        for i in range(num):
            ...
            image_crop = tf.image.random_crop(image, [90, 90, 3])
        ...
        with tf.compat.v1.Session() as sess:
            ...
            for idx, re in enumerate(results):
                with open('data/predata/cropImg/' + str(idx) + '.png', 'wb') as f:
                    f.write(re)
...
def crop(image_file):
    ...
    cv2.imwrite("./data/predata/pre0002.jpg", cropped)
